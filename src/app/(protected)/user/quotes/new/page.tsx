  ...
  return (
    <main className=" min-h-[calc(100vh-130px)] flex flex-col justify-center items-center">
      {state.message && !state.success && (
        <div className="my-6 flex items-center gap-3 rounded-xl border p-4 text-sm font-medium shadow-sm transition-all animate-in fade-in slide-in-from-top-2 max-w-md w-full bg-destructive/10 border-destructive/20 text-destructive">
